...
class Pyre_Latest_Blog_Media_Widget extends WP_Widget {
	...
	function __construct()
	{
		...
		parent::__construct('pyre_homepage_media-widget', 'Camp: Homepage Latest Blog Posts', $widget_ops, $control_ops);
	}
	...
	function form($instance)
	{
		...
		$defaults = array('title' => 'Latest Blog Posts', 'categories' => 'all', 'posts' => 4, 'columns' => 4);
