...
class Tweets_Widget extends WP_Widget {
	...
	function __construct()
	{
		...
		parent::__construct('tweets-widget', 'Camp: Tweets', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		if($twitter_id) { ?>
			 <a href="http://twitter.com/<?php echo $twitter_id; ?>" class="def-button widget-butt" target="_blank">Follow Us</a>
