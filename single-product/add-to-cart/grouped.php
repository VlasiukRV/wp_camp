...
<form action="<?php echo esc_url( $product->add_to_cart_url() ); ?>" class="cart" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button button alt add-to-cart"><?php echo apply_filters('single_add_to_cart_text', __( 'Add to Basket', 'woocommerce' ), $product->product_type); ?></button>
